...
$modificado = $conexion->prepare("UPDATE video SET Titulo=:tit, Genero=:gen, Any=:any, Precio=:pre, caratula = :cara WHERE id = :idAModificar ;");
$modificado->bindParam(':idAModificar',$_POST["id"]);
